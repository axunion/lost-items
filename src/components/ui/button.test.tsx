...
describe("Button", () => {
  ...
  describe("size prop", () => {
    ...
    it("applies sm size class", () => {
      ...
      expect(screen.getByRole("button").className).toContain(styles.sizeSm);
    });

    it("applies xl size class", () => {
      render(() => <Button size="xl">XL</Button>);
      expect(screen.getByRole("button").className).toContain(styles.sizeXl);
    });

    it("applies icon size class", () => {
      render(() => <Button size="icon">i</Button>);
      expect(screen.getByRole("button").className).toContain(styles.sizeIcon);
    });
  });

  describe("class prop", () => {
    it("merges custom class with built-in classes", () => {
      render(() => <Button class="custom-class">Merge</Button>);
